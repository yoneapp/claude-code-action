...
||||||| parent of 9c0245a (Enable OAuth support for Claude Code Action workflows and update examples)
...
=======
          timeout_minutes: "60"
>>>>>>> 9c0245a (Enable OAuth support for Claude Code Action workflows and update examples)
```
...
steps:
  - uses: yoneapp/claude-code-action@beta # Fork with OAuth support
    with:
      direct_prompt: |
